...
$(function() {
	...
	if($(top.window.document.getElementById("dialogWinSaveBtn"))){
		$(top.window.document.getElementById("dialogWinSaveBtn")).show();
	}
...
function hideButton(){
	$(top.window.document.getElementById("dialogWinSaveBtn")).hide();
}
