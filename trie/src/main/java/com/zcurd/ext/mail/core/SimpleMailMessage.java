...
public class SimpleMailMessage implements MailMessage, Serializable {
	...
	public boolean equals(Object other) {
		...
		return (nullSafeEquals(this.from, otherMessage.from) && nullSafeEquals(this.replyTo, otherMessage.replyTo)
				&& Arrays.equals(this.to, otherMessage.to) && Arrays.equals(this.cc, otherMessage.cc)
				&& Arrays.equals(this.bcc, otherMessage.bcc) && nullSafeEquals(this.sentDate, otherMessage.sentDate)
				&& nullSafeEquals(this.subject, otherMessage.subject) && nullSafeEquals(this.text, otherMessage.text));
	}
	...
	public int hashCode() {
		...
		return 29 * hashCode + ((this.text == null) ? 0 : this.text.hashCode());
	}
